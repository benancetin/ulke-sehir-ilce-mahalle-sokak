...
--
-- Host: 172.72.0.16
-- Generation Time: Sep 07, 2020 at 09:00 PM
...
INSERT INTO `ilce` (`ilce_id`, `ilce_adi`, `ilce_key`, `sehir_key`) VALUES
(1, 'ADALAR', 1103, 34),
...
--
ALTER TABLE `ilce`
  MODIFY `ilce_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=971;
COMMIT;
